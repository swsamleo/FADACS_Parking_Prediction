...
from stgcn_models.trainer import model_train
from stgcn_models.tester import model_test
...
blocks = [[4, 128, 256], [256, 128, 512]]

# Load wighted adjacency matrix W
if args.graph == 'default':
    W = weight_matrix(pjoin('./dataset', f'PeMSD7_W_{n}.npy'))
else:
