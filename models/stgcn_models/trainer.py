...
from stgcn_utils import gen_batch
from stgcn_models.tester import model_inference
from stgcn_models.base_model import build_model, model_save
...
def model_train(inputs, blocks, args, sum_path='./output/tensorboard'):
    ...
    x = tf.placeholder(tf.float32, [None, n_his + 1, n, 4], name='data_input')
